...
function getBus(){
	 //企业或车辆
	 var busNumOrEnterprise=$("#busNumOrEnterprise").val();
	 $.ajax({ 
		data:{
			busNumOrEnterprise:busNumOrEnterprise,
    	},
    	type:"GET",
		dataType:'json',
...
// 获取所有车皮位置数据信息
function getPosition(busNumOrEnterprise) {
	if(busNumOrEnterprise!=null){
		executeflag=busNumOrEnterprise;
	}
	$.ajax({
		data:{
			busNumOrEnterprise:busNumOrEnterprise,
