...
<html>
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <table class="layui-table" id="user" lay-filter="demo">
      </table>
    </div>
         ...
         //table加载
       	 var table = layui.table;
			 table.render({
       	     ...
       	     ,where: {urltype:"user"} //如果无需传递额外参数，可不加该参数
             ,page:{prev:['上一页'],next:['下一页'],layout: ['prev', 'page', 'next']}
       	     ,cols: [[
               {field: '',width:'10%', title: '序号', sort: true,align:'center',templet: '#indexTpl'}
       	      ,{field:'enterpriseId', width:'10%', sort: true,title: '所属企业',templet: '<div>{{ getEnterpriseName(d.enterpriseId) }}</div>'}
       	      ,{field:'userName', width:'10%', sort: true,title: '用户名'}
       	      ,{field:'userPwd', width:'10%', title: '用户密码',sort: true}
       	      ,{field:'userType', width:'10%', sort: true,title: '用户类型',templet: '#userTypeTpl' }
       	      ,{field:'userRealName', width:'10%', sort: true,title: '真实姓名'}
       	      ,{field:'userTelephone', width:'10%', sort: true,title: '电话号码'}
       	      ,{field:'userSex', width:'10%', sort: true,title: '性别',templet: '#userSexTpl' }
