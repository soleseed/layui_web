         ...
         <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="mac" name="mac"   lay-verify="required" value="${mac}"
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="wanIp" name="wanIp"   lay-verify="required" value="${wanIp}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="ssid" name="ssid"   lay-verify="required" value="${ssid}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="totalFlew" name="totalFlew"   lay-verify="required" value="${totalFlew}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="remainFlew" name="remainFlew"   lay-verify="required" value="${remainFlew}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="portalVersion" name="portalVersion"  lay-verify="required" value="${portalVersion}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="firmWareVersion" name="firmWareVersion"  lay-verify="required" value="${firmWareVersion}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
