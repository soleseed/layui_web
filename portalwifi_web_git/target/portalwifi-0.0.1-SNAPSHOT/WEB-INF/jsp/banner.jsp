...
<%-- <script src="${pageContext.request.contextPath }/js/videojs/video.min.js"></script> 
<link href="${pageContext.request.contextPath }/css/videojs/video-js.css" rel="stylesheet"> --%>
